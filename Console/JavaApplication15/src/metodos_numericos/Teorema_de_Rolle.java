...
public class Teorema_de_Rolle extends javax.swing.JFrame {
    ...
    /**
     * Creates new form Teorema_de_Rolle
     */
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            dPorcentajeError = Float.parseFloat(txtPorcentaje.getText());
...
do{
        ...
        pendiente = (dFuncionB - dFuncionA) / (dIntervaloB - dIntervaloA);
        System.out.println("Pendiente: "+pendiente);
        if(dFuncionB*dFuncionA ==0){ 
            JOptionPane.showMessageDialog(null, "Se encontro la raiz");
            break;
        }else if(dFuncionB*dFuncionA>0){
            JOptionPane.showMessageDialog(null, "Ingrese otro intervalo");
            break;
        }else{
            
        error=Math.abs((pm - auxfuncionA) / pm) * 100;
        Tanteta = (float) Math.atan(pendiente);
        valorteta =(float)Math.toDegrees(Tanteta);
        ...
        if(dFuncionB*dFuncionA<0){
            ...
            dIntervaloA=auxfuncionA;
            dIntervaloB=auxfuncionB;
            cont=0;
            System.out.println("");
        }
        }
